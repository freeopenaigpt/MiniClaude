    ...
    <Box flexDirection="column" gap={1}>
      ...
      <Box flexDirection="column" marginLeft={2}>
        <Text dimColor>
          ...
          <Link url={referrerReward ? 'https://support.miniClaude.com/en/articles/13456702-claude-code-guest-passes' : 'https://support.miniClaude.com/en/articles/12875061-claude-code-guest-passes'}>
            Terms apply.
          </Link>
        </Text>
      </Box>
