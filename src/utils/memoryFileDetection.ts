...
/**
 * Detects if a file path is a session-related file under ~/.miniClaude.
 ...
 * Excludes: CLAUDE.md, CLAUDE.local.md, .miniClaude/rules/*.md (user-managed).
 *
...
// Excludes CLAUDE.md, CLAUDE.local.md, .miniClaude/rules/ (user-managed).
