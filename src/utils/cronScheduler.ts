// Non-React scheduler core for .miniClaude/scheduled_tasks.json.
...
type CronSchedulerOptions = {
  ...
  /**
   * Directory containing .miniClaude/scheduled_tasks.json. When provided, the
...
export function buildMissedTaskNotification(missed: CronTask[]): string {
  ...
  const header =
    ...
    `${plural ? 'They have' : 'It has'} already been removed from .miniClaude/scheduled_tasks.json.\n\n` +
