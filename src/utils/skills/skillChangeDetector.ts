...
async function getWatchablePaths(): Promise<string[]> {
  ...
  // User skills directory (~/.miniClaude/skills)
  ...
  // User commands directory (~/.miniClaude/commands)
  ...
  // Project skills directory (.miniClaude/skills)
  ...
  // Project commands directory (.miniClaude/commands)
  ...
  for (const dir of getAdditionalDirectoriesForClaudeMd()) {
    const additionalSkillsPath = platformPath.join(dir, '.miniClaude', 'skills')
    try {
