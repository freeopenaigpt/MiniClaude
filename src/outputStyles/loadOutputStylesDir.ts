...
/**
 * Loads markdown files from .miniClaude/output-styles directories throughout the project
 * and from ~/.miniClaude/output-styles directory and converts them to output styles.
 *
 ...
 *
 * Structure:
 * - Project .miniClaude/output-styles/*.md -> project styles
 * - User ~/.miniClaude/output-styles/*.md -> user styles (overridden by project styles)
 *
